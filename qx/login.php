...
<body>
	...
	<ul>
		<li><a href="../">返回首页</a></li>
		<li><a href="http://qxkkk.bid" target="_blank">发布者主站</a></li>
	</ul>
</div>
<div class="mt2"></div>
...
<tr class="header">
			<td colspan="4" align="center" style=" height:50px; font-size:18px; font-weight:bold;    background-color: #ecf1fc;">七星影院系统登陆</td>
</tr>
