				...
				<table width="90%"  align="center" cellpadding="5" cellspacing="1" class="tablecss" >
					...
					<tr>
					  ...
					  <td width="690" valign="middle">
					  	...
					  	<span class="gray tips">如：七星影院</span>
					  </td>
					</tr>
					<tr>
					    ...
					    <td width="690" valign="middle">
					      ...
					      <span class="gray tips">网站域名，如 http://qxkkk.bid </span>
					    </td>
					</tr>
					<tr>
					...
					<tr>
					    ...
					    <td valign="top">请将解析接口分别填入下列空中<font color="red">（第一条是默认调用接口）</font><div class="cl5"></div>
							...
							<input type="text" name="aik[jiekou16name]" class="shuru" placeholder="名称：" value="<?php echo $aik['jiekou16name']?>" size=20" ><input type="text" name="aik[jiekou16]" placeholder="接口url：" class="shuru" value="<?php echo $aik['jiekou16']?>" size="80" ><br/>
							<input type="text" name="aik[jiekou17name]" class="shuru" placeholder="名称：" value="<?php echo $aik['jiekou17name']?>" size=20" ><input type="text" name="aik[jiekou17]" placeholder="接口url：" class="shuru" value="<?php echo $aik['jiekou17']?>" size="80" ><br/>
							<input type="text" name="aik[jiekou18name]" class="shuru" placeholder="名称：" value="<?php echo $aik['jiekou18name']?>" size=20" ><input type="text" name="aik[jiekou18]" placeholder="接口url：" class="shuru" value="<?php echo $aik['jiekou18']?>" size="80" ><br/>
							<input type="text" name="aik[jiekou19name]" class="shuru" placeholder="名称：" value="<?php echo $aik['jiekou19name']?>" size=20" ><input type="text" name="aik[jiekou19]" placeholder="接口url：" class="shuru" value="<?php echo $aik['jiekou19']?>" size="80" ><br/>
							<input type="text" name="aik[jiekou20name]" class="shuru" placeholder="名称：" value="<?php echo $aik['jiekou20name']?>" size=20" ><input type="text" name="aik[jiekou20]" placeholder="接口url：" class="shuru" value="<?php echo $aik['jiekou20']?>" size="80" ><br/>
							</td>
					</tr>
					<tr>
